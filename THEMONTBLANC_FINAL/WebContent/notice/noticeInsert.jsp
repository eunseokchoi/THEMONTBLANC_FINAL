...
<html>
<head>
<title>noticeInsert 공지사항 글쓰기폼 영역</title>

<link rel="stylesheet" type="text/css" href="admin/css/admin.css">
<link rel="stylesheet" type="text/css" href="notice/css/notice_board.css"> <!-- 공지글 board 글쓰기에디트 폼영역 스타일부분 -->
...
<div id="adminF" >
     ...
     <div id="admin_title2">공지사항 글쓰기</div>
      <table id="admin_tableF2" >
        <tr>
         ...
         <td class="bd_style" style="border-top:5px solid #eceae1;"><input type=text name=title class="adminS" id="tb_title2"></td>
        </tr>
        <tr>
         <td class="adminB" id="tb_title">이름</td>
         <td class="bd_style"><input type="text" name="name" class="adminS" id="tb_title2"></td>
        </tr>
        <!-- boardEditor start -->
        ...
        <!-- boardEditor end -->
        <tr>
         <td class="adminB" style="vertical-align:top; border-bottom:4px solid #eceae1;" id="tb_title">내용</td>
         <td class="bd_style" style="border-bottom:4px solid #eceae1;"><textarea name='contents' id="asd" style="vertical-align:bottom; overflow-x: hidden; overflow-y: scroll" class="board_style"></textarea></td>
        </tr>
      </div><!-- board_editor -->
      </table>
   </div><!-- adminF2 -->
   ...
   <!-- 버튼부분 -->
      <input type=submit value="확인" class="bt"> <!-- 공지글쓰고 나서 저장버튼 -->
   </form>   
      <a href='notice.do'><input type='button' value="취소" class="bt"></a>    <!-- 취소버튼 -->
</div><!-- adminF -->
